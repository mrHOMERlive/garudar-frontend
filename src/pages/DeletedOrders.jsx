...
import { ArrowLeft, Search, Trash2, Globe } from 'lucide-react';
...
export default function DeletedOrders() {
  ...
  }, [deletedOrders, search]);

  return (
    <div className="min-h-screen bg-slate-50">
      <header className="bg-slate-700 border-b border-slate-800/20 shadow-lg">
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-slate-50">
                ...
                <TableHead className="text-slate-700 font-semibold">Date Created</TableHead>
                <TableHead className="text-slate-700 font-semibold">Amount</TableHead>
                <TableHead className="text-slate-700 font-semibold">Beneficiary</TableHead>
